$(function(){
    ...
    function init(){
        ...
        color = new THREE.Color("rgb(51,0,255)");
        ...
        for  (var i=0;i < 1000; i++){
            cubeGeometry = new THREE.SphereGeometry(0.5, 0.5, 0.5);
            cubeMaterial = new THREE.MeshPhongMaterial({color:frequencyData[i]*0x3300ff});
    ...
    function render() {
        scene.traverse(function (e){
            if (e instanceof THREE.Mesh){
                ...
                e.material.color.setRGB(frequencyData[e.id]/0,0,0);
            }
        });
        ...
        zoom += 0.01*(frequencyData[2]/100);
        if ( zoom <= 0.01*(frequencyData[20]/100) || zoom >= 1*(frequencyData[20]/50) ){
            zoom -= 0.1*(frequencyData[240]/100);
        }

        spotLight.intensity =frequencyData[2]*5;
        camera.rotation.y = 90 * Math.PI / 180;
        camera.rotation.z = 90 * Math.PI / 180;
//        camera.rotation.x = frequencyData[0] * Math.PI / 180;
    }
